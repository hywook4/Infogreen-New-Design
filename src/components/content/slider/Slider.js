                ...
                <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" data-interval="4000">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src={require('../../../assets/images/la.jpg')} className="img-fluid d-block w-100" alt="First Slide" />
                        </div> 
                        
                        <div className="carousel-item">
                            <img src={require('../../../assets/images/la.jpg')} className="img-fluid d-block w-100" alt="Second Slide"/>
                        </div> 
                        <div className="carousel-item">
                            <img src={require('../../../assets/images/la.jpg')} className="img-fluid d-block w-100" alt="Third Slide"/>
                        </div> 
                    </div>    
